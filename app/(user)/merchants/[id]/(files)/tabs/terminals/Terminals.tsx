...
import { useTerminalRowActions } from '../../../transaction-details/[serial]/(files)/terminal-row-actions';
  ...
  return (
    <>
      ...
      <DataTable
        ...
        detailsView='page'
        detailsPageUrl={(row) => `${pathname}/transaction-details/${encodeURIComponent(row.serial)}`}
